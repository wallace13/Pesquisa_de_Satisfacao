                ...
                <div class="card-body">
                    <fieldset disabled>
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" value="{{ $almoco->data }}">
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-label">Salada</label>
                            <input type="text" class="form-control" value="{{ $almoco->salada }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Complemento</label>
                            <input type="text" class="form-control" value="{{ $almoco->complemento }}">
                        </div> 
                        <div class="mb-3">
                            <label class="form-label">Principal</label>
                            <input type="text" class="form-control" value="{{ $almoco->principal }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Sobremesa</label>
                            <input type="text" class="form-control" value="{{ $almoco->sobremesa }}">
                        </div>  
                        <div class="mb-3">
                            <label class="form-label">Suco</label>
                            <input type="text" class="form-control" value="{{ $almoco->suco }}">
                        </div>
                        <div class="mb-3">
                    ...
                    @php
                        if ($msg == "Cadastro criado com sucesso!" || $msg == "Edição efetuada com sucesso!") {
                            $rota1 = url()->previous();
                            $name1 = "Voltar";
                            $rota2 = route('almoco.index');
                            $name2 = "Confirmar";
                            $cor = "btn btn-success";
                        } else {
                            $rota1 = route('almoco.index');
                            $name1 = "Cancelar";
                            $rota2 = route('almoco.edit', $almoco->id);
                            $name2 = "Editar";
                            $cor = "btn btn-danger" ;
                        }                        
